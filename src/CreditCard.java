...
public class CreditCard extends Card {
    ...
    public CreditCard(String cardNumber, Account linkedAccount, String pin, BigDecimal dailyLimit) {
    ...
    public static CreditCard fromCSV(String csvLine) {
        ...
        CreditCard card = new CreditCard(cardNumber, null, pin, dailyLimit);
